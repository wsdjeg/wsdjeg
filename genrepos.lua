...
local function generate_content()
        local repos = {'flygrep.nvim', 'nvim-plug', 'tasks.nvim', 'code-runner.nvim', 'tabline.nvim', 'statusline.nvim', 'todo.nvim'}
        local lines = {}
        for _, repo in ipairs(repos) do
                table.insert(lines, '<a href="https://github.com/wsdjeg/' .. repo .. '">')
                table.insert(lines, '  <img align="center" src="https://github-readme-stats.vercel.app/api/pin/?username=wsdjeg&repo=' .. repo .. '" />')
